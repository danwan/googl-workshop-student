...
> **Workshop role:** Day 1 core with standalone Lab 7.4. Day 2 core with Labs 7.0, 7.1, 7.1.1, and 7.2; bonus with Lab 7.3.
...
| **[Lab 7.1.1 — ADK Under the Hood](./lab-7.1.1-adk-under-the-hood.md)** | Follow a request through ADK Web to understand the runtime, model, tool, events, sessions, and workflow options. |
